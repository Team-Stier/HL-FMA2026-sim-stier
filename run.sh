...
CLEAN
colcon build --base-paths src/interfaces src/tf_broadcasting src/visualization --cmake-clean-cache
...
echo "Starting TF + Visualizer + RViz. Bridge/Tracker/Planner/Control are not implemented here."
